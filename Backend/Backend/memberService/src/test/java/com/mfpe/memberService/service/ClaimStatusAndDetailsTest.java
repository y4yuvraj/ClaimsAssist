...
public class ClaimStatusAndDetailsTest {
	 ...
	 * 
	 * @Test void testGetBillsMethod() { Date d1 = Date.valueOf("2021-05-04"); Date
	 * d2 = Date.valueOf("2020-06-04");
	 * 
	 * Bills bill = new Bills("221","P2314", d1,65600,1200,d2);
	 * billsRepo.save(bill); assertThat(billsRepo.findById("221")).isNotNull(); }
	 */
